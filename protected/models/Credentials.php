...
class Credentials extends CActiveRecord {
	 ...
	 */
	public function findDefault($userId, $serviceType,$noFallBack = false){
	...
	public function getServiceLabels(){
		return array(
			...
			'x2HubConnector' => Yii::t('app', 'X2Hub Connector'),
                        'docs' => Yii::t('app', 'Document Account'),
	...
	public static function getCredentialOptions (
        ...
        field is being used: */
                //give admin ability to see all emails credentials
                if(Yii::app()->params->isAdmin && $model == "WORKFLOW"){
