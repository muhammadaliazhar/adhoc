 ...
 */
class BuyerMatchHistoryWidget extends SortableWidget {
    ...
    public $viewFile = '_buyerMatchHistoryWidget';
    ...
    public function renderWidgetLabel () {
        ...
        echo "<div class='widget-title'>Buyer Match History</div>";
    }
