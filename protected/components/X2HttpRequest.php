...
class X2HttpRequest extends CHttpRequest {
    ...
    private $csrfValidationWhitelist = array (
        ...
        '/^site\/DocUpdate$/', // allow Docusign to hit this url
        '/marketing\/marketing/', // allow donotemail
        '/^docs\/searchKb$/', // allow knowledge base search
        '/^docs\/kbView$/', // allow knowledge base docs access 
        '/^x2sign\/GetSelectedDropdown$/', // allow recipient to get dropdown
