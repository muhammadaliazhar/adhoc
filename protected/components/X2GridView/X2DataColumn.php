    ...
    public function getFilterCellContent () {
        switch($this->fieldType){
            ...
            default:
                ...
                //this will be for rendering the share to field for grid views
                if($this->name == "sharedTo" && ($this->id == "contactsgridC_sharedTo" || $this->id == "opportunitiesgridC_sharedTo" || $this->id == "listings2gridC_sharedTo" )){

                        return CHtml::activeDropdownList(
                            $this->grid->filter, $this->name,
                            User::getUserIdsForGrid(),
                            array(
                                'class' => 'x2-minimal-select-filtercol'
                            )
                        );
