...
if ($container == 1): ?>
	...
	style="width: <?php echo $widths[1] ?>">
	    ...
	    <?php 
        $this->widget('NewContest');
        //$this->widget('TopOffice');
        $this->widget('TopSalesChart'); 
		?>
...
<div id='create-profile-widget-dialog' class='form' style='display: none;'>
    ...
    unset($widgetSubtypeOptions['DocsGridViewProfileWidget']);
    unset($widgetSubtypeOptions['DocViewerProfileWidget']);
    unset($widgetSubtypeOptions['Documents::TemplatesGridViewProfileWidget']);
    unset($widgetSubtypeOptions['Docusign_fields::TemplatesGridViewProfileWidget']);
    unset($widgetSubtypeOptions['Docusign_templates::TemplatesGridViewProfileWidget']);
