...
Yii::app()->clientScript->registerCss('inquiriesEmailFormCss',"
.cke_combopanel {
    display: none;
}
...
#inquiries-email-form form {
    position: relative;
}
#inquiries-email-form label {
	width:80px;
}
#inquiries-email-form .cancel-send-button {
    margin-right: 0;
}
#inquiries-email-form input[type='text'], #inquiries-email-form textarea {
	width:465px;
}
#inquiries-email-form a {
	text-decoration:none;
}
#inquiries-email-form input#emailSendTime {
	width:120px;
}
...
#inquiries-cc-row > input,
#inquiries-bcc-row > input {
...
#inquiries-cc-row.show-input-name::before {
    content: 'Cc';
}

#inquiries-bcc-row.show-input-name::before {
    content: 'Bcc';
}
...
Yii::app()->clientScript->registerResponsiveCss('inquiriesEmailFormResponsiveCss',"
...
@media (max-width: 840px) {
    #inquiries-email-form .email-input-row > input {
        width: 50% !important;
    }
    #InlineEmail_subject {
        display: block;
...
?>
<div class="form email-status" id="inquiries-email-status" style="display:none"></div>
<div id="inquiries-email-top"></div>

<div id="inquiries-email-form" <?php echo $this->startHidden ? "style='display: none;'" : ''; ?>
...
//        ));
    ...
    <div class='email-inputs form'>
        <div class="row">
            <div id="inquiries-email-errors" class="error" style="display:none"></div>
    ...
    <div class='addressee-rows'>
        <div class="row email-input-row email-to-row show-input-name">
            ...
            <div class='toggle-container'>
                <a href="javascript:void(0)" 
                 id="inquiries-cc-toggle"<?php if(!empty($this->model->cc)) echo ' style="display:none;"'; ?>>
                    Cc
                </a>
                <a href="javascript:void(0)" 
                 id="inquiries-bcc-toggle"<?php if(!empty($this->model->bcc)) echo ' style="display:none;"'; ?>>
                    Bcc</a>
            </div>
        </div>
        <div class="row email-input-row show-input-name" id="inquiries-cc-row" 
        ...
        <div class="row email-input-row show-input-name" id="inquiries-bcc-row"
        ...
        <div class="row email-input-row">
            ...
            if (!isset($this->template) && 
                ...
                // When sending an InquiriesEmail targeting a Quote
    ...
    <div class="row bottom-row-outer">
        ...
        <div class="row buttons last-button-row">
            ...
            // if(is_file(__DIR__.'/inquiriesEmailForm_pro.php'))
            // include('inquiriesEmailForm_pro.php');
            ...
            echo CHtml::ajaxSubmitButton(
                ...
                array(
                    'beforeSend' => "setInquiriesEmailFormLoading",
                    'dataType' => 'json',
                    'success' => "function (data) {
                        x2.inquiriesEmailEditorManager.handleInquiriesEmailActionResponse (data);
                    }",
                ), 
                array(
                    ...
                    'onclick' => '
                        if (!x2.isAndroid) window.inquiriesEmailEditor.updateElement();
