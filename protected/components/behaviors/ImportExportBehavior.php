...
class ImportExportBehavior extends CBehavior {
    ...
    protected function createImportMap($attributes, $meta) {
        ...
        foreach ($meta as $metaVal) {
            ...
            // Second metaVal for custom fields
            $metaVal2 = 'c_' . strtolower($originalMetaVal);
            /*
            ...
            if (in_array($metaVal, $attributes)) {
                ...
                /*
                 * This possibility is specific to transworld where we also take into account
                 * the ending and beginning 'c' for custom fields
                 */
            } elseif (in_array($metaVal2, $attributes)) {
                $attrKey = array_search($metaVal2, $attributes);
                $_SESSION['importMap'][$originalAttributes[$attrKey]] = $originalMetaVal;
                /*
