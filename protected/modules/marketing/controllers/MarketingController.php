...
class MarketingController extends x2base {
    ...
    public function accessRules() {
        return array(
            ...
            /* x2entstart */
            array('allow',
                'actions' => array('landingPage'),
                'users' => array('*'),
            ),
            array('allow',
                'actions' => array('landingPages'),
                'users' => array('@'),
            ),
            /* x2entend */
    ...
    public function actions() {
        return array_merge(parent::actions(), array(
            ...
            /* x2entstart */
            'landingPages' => array(
                'class' => 'application.components.LandingPageDesigner.LandingPageDesignerAction',
            ),
            'landingPage' => array(
                'class' => 'application.components.LandingPageAction',
            ),
            /* x2entend */
            'inlineEmail' => array(
    ...
    public function insertMenu($selectOptions = array(), $model = null, $menuParams = null) {
        ...
        $menuItems = array(
            ...
            array(
                'name' => 'landingPages',
                'label' => Yii::t('marketing', 'Landing Pages'),
                'url' => array('landingPages')
            ),
            /* x2entend */
            array(
                'name' => 'webtracker',
