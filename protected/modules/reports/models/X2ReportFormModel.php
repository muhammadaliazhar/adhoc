...
abstract class X2ReportFormModel extends CFormModel {
    ...
    public $groupRecords = array();
    public $allFilters = array ();
    public $anyFilters = array ();
    public $RelitiveFilters = array ();
    ...
    */
    ...
    public function rules () {
        return array (
            array (
                'refreshForm, export, print, email, includeTotalsRow, permissionReport', 'boolean'
            ), 
            array (
            ...
            array (
                'allFilters,anyFilters,RelitiveFilters,groupRecords',
    ...
    public function attributeLabels () {
	    ...
	    'RelitiveFilters' => Yii::t('reports', 'Relative time:'), 
            'includeTotalsRow' => Yii::t('reports', 'Include totals row?'), 
            'permissionReport' => Yii::t('reports', 'Grant other users admin\'s view on this report.<span style= "color:red">(admin only)<span/>'),
	);
    }
        ...
        foreach ($value as &$arr) {
            if (array_keys ($arr) !== array ('name', 'operator', 'value') ||
                !in_array ($arr['operator'], array ('=', '>', '<', '>=', '<=', '<>', 'notEmpty',
                    'empty', 'list', 'notList', 'noContains', 'contains' , 'containsUsers'), true)) {
