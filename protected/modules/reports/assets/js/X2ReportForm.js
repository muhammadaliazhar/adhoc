...
function buyerOpenDialog(id) {
    var url = yii.scriptUrl + '/reports/reportInfo' + '?id=' + id;
    var buyerListButton$ = $('#create-buyer-list');
    var info = $('<div />');
    info.prop('id', 'buyer_list');
    info.prop('title', 'Create A Buyer List');
    $.ajax({
        url: url,
        type: 'GET',
