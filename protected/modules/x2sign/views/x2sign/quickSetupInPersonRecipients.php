                    ...
                    <form id="recipientForm" method="post" action="<?php echo Yii::app()->controller->createUrl('/x2sign/quickSetupTemplate', array('id' => $envelope->id)); ?>">
                        <div id="recipient-card" class="card col p-5 mb-5 mt-2 form-group recipient shadow-sm">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-4">
                                    <label for="recipientRoleSelect" class="mt-3"> Recipient Role <span class="field-required">*</span> </label>
                                    <select class="recipientRoleSelect form-control" name="recipientRoleSelect" required>
                                        <option value="false">Sign Via Email</option>
                                        <option value="true">In-Person Sign</option>
                                    </select>
                                </div>
                            </div>
