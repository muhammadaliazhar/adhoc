    ...
    $('#next-page-button').on('click', function() {
        ...
        $('.recipient').each(function() {
            recipients.push({
                ...
                'displayModel': 'Contacts', //$(this).find('.sendModel').val(),
...
<div class="review-send-container section-container container">
    <div class="section-header">
        <h3 id="add-documents">Review and Send</h3>
        ...
        <div class="row ml-0 mt-3">
            <form id="emailForm">
                ...
                <div class="form-group">
                    ...
                    <?php echo X2Html::activeDatePicker (new X2SignEnvelopes, 'sendDate', array ('id' => 'sendDate', 'name' => 'sendDate'  ), 'datetime'); ?>
                </div>

                <div class="form-group">
                    <?php echo CHtml::label(Yii::t('marketing','Expiration Date (optional)'), ''); ?>
                    <?php echo X2Html::activeDatePicker (new X2SignEnvelopes, 'expireDate', array ('id' => 'expireDate', 'name' => 'expireDate'  ), 'datetime'); ?>
                </div>
