...
$modelType = json_encode("Inquiries");
...
<div class="page-title-fixed-outer">
    <div class="page-title-fixed-inner">
        <div class="page-title inquiries">
            <h2>
            ...
            echo X2Html::addSendNDAQuickButton($model->id);
            ?>
        </div>
    </div>
</div>
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'inquiries')); ?>
