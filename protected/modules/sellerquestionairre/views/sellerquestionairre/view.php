...
include("protected/modules/sellerquestionairre/sellerquestionairreConfig.php");
    ...
    array(
        ...
        'linkOptions' => array(
            ...
            Yii::app()->createUrl('/site/printRecord', array(
                'modelClass' => "Sellerquestionairre",
                'id' => $model->id,
                'pageTitle' =>
...
$modelType = json_encode("Sellerquestionairre");
...
<div class="page-title-fixed-outer">
    <div class="page-title-fixed-inner">
        <div class="page-title sellerquestionairre">
            <h2>
...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'sellerquestionairre')); ?>
...
$this->widget ('ModelFileUploader', array(
    'associationType' => 'sellerquestionairre',
