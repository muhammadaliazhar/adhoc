...
$this->widget('X2GridView', array(
	'id'=>'sellerquestionairre-grid',
	'title'=> "Seller Questionnaire List", // Modules::displayName(true, $moduleConfig['moduleName']),
	'buttons'=>array('advancedSearch','clearFilters','columnSelector','autoResize','showHidden'),
	'template'=> 
        '<div id="x2-gridview-top-bar-outer" class="x2-gridview-fixed-top-bar-outer">'.
        '<div id="x2-gridview-top-bar-inner" class="x2-gridview-fixed-top-bar-inner">'.
        '<div id="x2-gridview-page-title" '.
         'class="page-title x2-gridview-fixed-title sellerquestionairre">'.
	...
	'filter'=>$model,
	// 'columns'=>$columns,
	'modelName'=>'Sellerquestionairre',
	'viewName'=>'sellerquestionairre',
