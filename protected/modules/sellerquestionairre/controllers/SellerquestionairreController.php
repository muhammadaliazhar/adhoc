...
class SellerquestionairreController extends x2base {

    public $modelClass = 'Sellerquestionairre';
    ...
    public function actionCreate() {
        $model=new Sellerquestionairre;
        $users=User::getNames();

        if(isset($_POST['Sellerquestionairre'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Sellerquestionairre']);
    ...
    public function actionIndex() {
        $model=new Sellerquestionairre('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='sellerquestionairre-form') {
