...
class MlistingsController extends x2base {

    public $modelClass = 'Mlistings';
    ...
    public function actionView($id) {
        if(!Yii::app()->params->isAdmin)throw new CHttpException(
                403,'Invalid request. Please do not repeat this request again.');
        $type='mlistings';
    ...
    public function actionCreate() {
        ...
        if(isset($_POST['Mlistings'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Mlistings']);
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='mlistings-form') {
