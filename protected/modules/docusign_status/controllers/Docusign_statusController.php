...
class Docusign_statusController extends x2base {

    public $modelClass = 'Docusign_status';
    ...
    public function actionCreate() {
        $model=new Docusign_status;
        $users=User::getNames();

        if(isset($_POST['Docusign_status'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Docusign_status']);
    ...
    public function actionIndex() {
        $model=new Docusign_status('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='docusign_status-form') {
