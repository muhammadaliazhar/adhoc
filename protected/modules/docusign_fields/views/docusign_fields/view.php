...
$modelType = json_encode("Docusign_fields");
...
<div class="page-title-fixed-outer">
    <div class="page-title-fixed-inner">
        <div class="page-title docusign_fields">
            <h2>
...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'docusign_fields')); ?>
...
$this->widget ('ModelFileUploader', array(
    'associationType' => 'docusign_fields',
