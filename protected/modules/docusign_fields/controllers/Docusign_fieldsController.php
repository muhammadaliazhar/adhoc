...
class Docusign_fieldsController extends x2base {

    public $modelClass = 'Docusign_fields';
    ...
    public function actionCreate() {
        $model=new Docusign_fields;
        $users=User::getNames();

        if(isset($_POST['Docusign_fields'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Docusign_fields']);
    ...
    public function actionIndex() {
        $model=new Docusign_fields('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='docusign_fields-form') {
