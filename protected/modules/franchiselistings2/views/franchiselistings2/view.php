...
$modelType = json_encode("Franchiselistings2");
...
<div class="page-title-fixed-outer">
    <div class="page-title-fixed-inner">
        <div class="page-title franchiselistings2">
            <h2>
...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'franchiselistings2')); ?>
...
$this->widget ('ModelFileUploader', array(
    'associationType' => 'franchiselistings2',
