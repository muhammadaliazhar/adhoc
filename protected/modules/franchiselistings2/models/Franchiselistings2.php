 ...
 */
class Franchiselistings2 extends X2Model {
	 ...
	 */
	public function tableName() { return 'x2_franchiselistings2'; }

	public function behaviors() {
		return array_merge(parent::behaviors(),array(
			'LinkableBehavior'=>array(
				'class'=>'LinkableBehavior',
				'module'=>'franchiselistings2'
			),
    ...
    public function beforeSave() {
        ...
        if (isset($name) && trim($name) !== '') {
            ...
            $name = str_replace('/', '-', $name);
            $listingUrl = "https://tworld.com/franchise/listings/" . $name;
            $this->c_listing_URL = $listingUrl;
