...
class Franchiselistings2Controller extends x2base {

    public $modelClass = 'Franchiselistings2';
    ...
    public function actionCreate() {
        if (!Yii::app()->params->isAdmin) throw new CHttpException(403, "Permission Denied. Only admins can create franchise listings");
        $model=new Franchiselistings2;
        $users=User::getNames();

        if(isset($_POST['Franchiselistings2'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Franchiselistings2']);
    ...
    public function actionUpdate($id) {
        if (!Yii::app()->params->isAdmin) throw new CHttpException(403, "Permission Denied. Only admins can modify franchise listings");
        $model = $this->loadModel($id);
        $users = User::getNames();
    ...
    public function actionIndex() {
        $model=new Franchiselistings2('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='franchiselistings2-form') {
