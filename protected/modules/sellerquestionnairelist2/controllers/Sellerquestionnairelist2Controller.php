...
class Sellerquestionnairelist2Controller extends x2base {

    public $modelClass = 'Sellerquestionnairelist2';
    ...
    public function actionCreate() {
        $model=new Sellerquestionnairelist2;
        $users=User::getNames();

        if(isset($_POST['Sellerquestionnairelist2'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Sellerquestionnairelist2']);

            if(isset($_POST['x2ajax'])){
                $ajaxErrors = $this->quickCreate ($model);
            } else{
                if ($model->save ()) {
//		    isset($mdoel->c_Listing) $model->
    ...
    public function actionIndex() {
        $model=new Sellerquestionnairelist2('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='sellerquestionnairelist2-form') {
