...
include("protected/modules/sellerquestionnairelist2/sellerquestionnairelist2Config.php");
...
$createMenu = NULL;
if(Yii::app()->params->isAdmin) $createMenu =  array('label' => Yii::t('module', 'Create {X}', array('{X}' => Modules::itemDisplayName())), 'url' => array('create'));
    ...
    array(
        ...
        'linkOptions' => array(
            ...
            Yii::app()->createUrl('/site/printRecord', array(
                'modelClass' => "Sellerquestionnairelist2",
                'id' => $model->id,
                'pageTitle' =>
...
$modelType = json_encode("Sellerquestionnairelist2");
...
<div class="page-title-fixed-outer">
    <div class="page-title-fixed-inner">
        <div class="page-title sellerquestionnairelist2">
            <h2>
            ...
            echo X2Html::inlineEditButtons();
                       $url1 = urlencode('http://tworldform.dev.saleselement.net:8080/form-x2/send-form/' . $model->id);
            echo CHtml::link('Resend Seller Questionnaire', 'http://sydney.tworld.com/index.php/site/ViewPageIframe/url/' . $model->id . '/link/3', array(
                'class' => 'x2-button icon right',
                'target' => '_blank',
            ));
             $url2 = urlencode('crm_user_id=' . Yii::app()->user->id  . '&crm_user_email=' . Yii::app()->params->profile->emailAddress  . '&co1=' . $model->id);
            echo CHtml::link('Create Presentation', 'http://sydney.tworld.com/index.php/site/ViewPageIframe/url/' . $url2 . '/link/2' , array(
                'class' => 'x2-button icon right',
                'target' => '_blank',
            ));
...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'sellerquestionnairelist2')); ?>
...
$this->widget ('ModelFileUploader', array(
    'associationType' => 'sellerquestionnairelist2',
