...
class AgreementsController extends x2base {

    public $modelClass = 'Agreements';
    ...
    public function actionCreate() {
        ...
        if(isset($_POST['Agreements'])) {
            ...
            $model->setX2Fields($_POST['Agreements']);
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='agreements-form') {
