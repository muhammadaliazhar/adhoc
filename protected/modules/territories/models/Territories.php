 ...
 */
class Territories extends X2Model {
	 ...
	 */
	public function tableName() { return 'x2_territories'; }
    ...
    /* public function beforeSave() {
        exec("python /var/www/transworld_crm/protected/commands/bin/geocodeTerritory.py '$this->c_City, $this->c_State, $this->c_Country'", $coords, $fail);
        $coords = explode("|", $coords[0]);
        $this->c_Territory_Latitude = (float) $coords[0];
        $this->c_Territory_Longitude = (float) $coords[1];
