...
include("protected/modules/royaltyreport/royaltyreportConfig.php");
...
?>
<div class="page-title royaltyreport"><h2><?php echo Yii::t('module','Update {X}',array('{X}'=>Modules::itemDisplayName())); ?> <?php echo $model->name; ?></h2></div>

<?php 
$this->widget ('FormView', array(
	'model' => $model
));
//echo $this->renderPartial('application.components.views.@FORMVIEW', array('model'=>$model,'users'=>$users, 'modelName'=>'royaltyreport')); ?>
