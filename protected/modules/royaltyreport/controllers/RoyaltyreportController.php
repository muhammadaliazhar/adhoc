...
class RoyaltyreportController extends x2base {

    public $modelClass = 'Royaltyreport';
    ...
    public function actionCreate() {
        $model=new Royaltyreport;
        $users=User::getNames();
        $this->redirect("https://sydney.tworld.com/index.php/opportunities/index");
        if(isset($_POST['Royaltyreport'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Royaltyreport']);
            ...
            if(isset($_POST['x2ajax'])){
                ...
                $model->c_Franchises = $franchisee->nameId;
    ...
    public function actionIndex() {
        $model=new Royaltyreport('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='royaltyreport-form') {
            echo CActiveForm::validate($model);
            Yii::app()->end();
        }
    }

    //this is the point for the deals button to create a report
    public function actionCreateFromDeals(){
        $model=new Royaltyreport;
        $model->name = $_GET["reportName"];
        $model->c_StartDate = strtotime($_GET["startDate"]);
        $model->c_EndDate = strtotime($_GET["endDate"]);
