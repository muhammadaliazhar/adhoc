...
class Docusign_testController extends x2base {

    public $modelClass = 'Docusign_test';
    ...
    public function actionCreate() {
        $model=new Docusign_test;
        $users=User::getNames();

        if(isset($_POST['Docusign_test'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Docusign_test']);
    ...
    public function actionIndex() {
        $model=new Docusign_test('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='docusign_test-form') {
