...
class CountiesController extends x2base {

    public $modelClass = 'Counties';
    ...
    public function actionCreate() {
        ...
        if(isset($_POST['Counties'])) {
            ...
            $model->setX2Fields($_POST['Counties']);
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='counties-form') {
