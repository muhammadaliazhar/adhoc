...
<div class="container" style='padding-left: 0px; padding-right: 0px; position: fixed; bottom: 0; z-index: 500;'>
    <div class="x2-vertical-tabs" style="width: 100%;">
        <div style="float: left; width: 100%; background-color: #f0f3f8;">
         <button class="tablinks" onclick="x2Tabs(event, 'Details')" id="defaultOpen">
            <i class="property-icons far fa-edit"></i>
            <div class="x2-tabs-title">Update</div>
        </button>
        </div>
    </div>
</div>
...
<div <?php //if(isset($background)) echo $background; ?> style='background: #203046;' class="preview-header">
    <div class="columns" style="width: 100%;">
        <div class="column">
            <div class="property-street"><i class="fas fa-user text-light" style="padding-right: 0.5rem; font-size: 1rem;"></i><?php echo $model->name; ?></div>
            <div class="property-zip"><i class="fas fa-envelope text-light" style="padding-right: 0.5rem; font-size: 1rem;"></i><?php echo $model->name; ?></div>
            <div class="property-inner"><i class="fas fa-phone text-light" style="padding-right: 0.5rem; font-size: 1rem;"></i><?php echo $model->name;  ?></div>
            <div class="property-inner"><?php //echo $model->assignedTo;  ?></div>
...
<div class="property-menu" style="padding-top: 10px; height:100%; border-radius: 30px 30px 0px 0px;">
    ...
    <div id="Details" class="tabcontent" style="margin-bottom: 150px;">
        <div class="column grid-view" id="properties-grid">
            <button onclick="updateRecord()" style=" margin-left: 25px;" id="updateRecord" type="button" class="btn btn-primary">Save</button>
            <table>
                <tbody>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Name: <?php echo $model->renderInput("name");?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td style=""><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">AssignedTo: <?php echo $model->renderInput('assignedTo');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Listing Number: <?php echo $model->renderInput('c_listing_number__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Listing Price: <?php echo $model->renderInput('c_listing_price__c',array("style"=>"width:100%"));?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Down Payment: <?php echo $model->renderInput('c_down_payment_requested__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Address: <?php echo $model->renderInput('c_address');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">City: <?php echo $model->renderInput('c_city__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">State: <?php echo $model->renderInput('c_state__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">County: <?php echo $model->renderInput('c_country__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Description: <?php echo $model->renderInput('c_business_description__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Client Status: <?php echo $model->renderInput('c_client_status__c',array("style"=>"width:100%"));?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">TOM Marketing Status: <?php echo $model->renderInput('c_tom_marketing_status__c',array("style"=>"width:100%"));?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Total Sales: <?php echo $model->renderInput('c_total_sales__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Ad Headline: <?php echo $model->renderInput('c_ad_headline__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Seller Discretionary Earnings: <?php echo $model->renderInput('c_seller_discretionary_earnings__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Client Agreement Date: <?php echo $model->renderInput('c_client_agreement_date__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Client Agreement Expires: <?php echo $model->renderInput('c_client_agreement_expires__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Seller: <?php echo $model->renderInput('c_Seller');?></div> </td></tr>
                </tbody>
            </table>
        </div>

        <button onclick="updateRecord()" style=" margin-left: 25px;margin-bottom: 125px;" id="updateRecord" type="button" class="btn btn-primary">Save</button>
        <script>
        //this will be the script for submiting the update
        function updateRecord(){
            var optionsToPass = [['Listings2_name','name'],['Listings2_assignedTo_assignedToDropdown','assignedTo'],['Listings2_c_listing_number__c','c_listing_number__c'],['Listings2_c_listing_price__c','c_listing_price__c'],['Listings2_c_down_payment_requested__c','c_down_payment_requested__c'],['Listings2_c_address','c_address'],['Listings2_c_city__c','c_city__c'],['Listings2_c_state__c','c_state__c'],['Listings2_c_country__c','c_country__c'],['Listings2_c_business_description__c','c_business_description__c'],['Listings2_c_client_status__c','c_client_status__c'],['Listings2_c_tom_marketing_status__c','c_tom_marketing_status__c'],['Listings2_c_total_sales__c','c_total_sales__c'],['Listings2_c_ad_headline__c','c_ad_headline__c'],['Listings2_c_seller_discretionary_earnings__c','c_seller_discretionary_earnings__c'],['Listings2_c_client_agreement_date__c','c_client_agreement_date__c'],['Listings2_c_client_agreement_expires__c','c_client_agreement_expires__c'],['Listings2_c_Seller_id0','c_Seller']];
            var passVars = {"id": <?php echo $model->id?> };
            optionsToPass.forEach(function(element){
                passVars[element[1]] = $("#" + element[0]).val();
            })
            console.log(passVars);
            document.location.href='<?php echo Yii::app()->createUrl('/listings2/mobileUpdate');?>'+ '?atts='+encodeURIComponent(JSON.stringify(passVars));
    ...
    <div id="Offers" class="tabcontent">
        ...
        <div id="signee-list" style="width: 95%; list-style-type: decimal; height: 150px; overflow-y: auto; border: 1px solid lightgrey; border-radius: 3px 3px 0px 0px; padding: 10px 0px;" class="ui-sortable">
            <li modelId="<?php echo $model->id;?>" modelType="Sellers2" style="border: 1px solid rgb(229, 229, 229); border-radius: 5px; cursor: pointer; background-color: rgb(255, 255, 255); margin: 0px 0px 5px 20px; max-width: 200px; padding: 5px; word-break: break-word;">
                <b><?php echo $model->name;?> - <?php echo $model->name;?></b> <a class="right delete" onclick="$(this).parent().remove();"><i class="far fa-times-circle"></i></a></li>
        ...
        <button id="send-button" class="btn btn-warning flex-item" onclick="SendDocMobile()">Send</button>
