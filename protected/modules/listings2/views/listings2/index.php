...
$ConFields = X2Model::model("Listings2")->getFields();
foreach($ConFields as $field){
    echo '<input type="hidden" id="Listings2[' . $field->fieldName . ']" name="Listings2[' . $field->fieldName . ']">';      
}
...
$this->widget('X2GridView', array(
	...
	'<div id="x2-gridview-top-bar-inner" class="x2-gridview-fixed-top-bar-inner">'.
        '<div id="x2-gridview-page-title" '.
         'class="page-title x2-gridview-fixed-title listings2">'.
