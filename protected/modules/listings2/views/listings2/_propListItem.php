<?php
    $listing = Listings2::model()->findByAttributes(array('nameId' => $data->nameId));
    $listingUrl = null;
    $listingName = null;
    ...
    //$phoneRaw = strtr($data->c_phone, array('(', ')', '-'));
            ...
            <div class="col-auto px-3" style="min-height: 100px;">
                <div class="row pb-3">
                    ...
                    <div id="seller-view-btn" class="d-flex justify-content-end col-4">
                        <button type="button" class="btn btn-view" style=""><a href="<?php echo Yii::app()->getBaseUrl(true) . "/index.php/listings2/" . $data->id ?>">VIEW</a></button>
                    </div>
                </div>
                <div class="row justify-content-between">
                    <div class="col-3" style="margin-bottom: 0.5rem;"><label style="font-size: 8px;color: #979191;display: block; margin-bottom: 0;">Listing Number</label><a  style="font-size: 8px;"><?php echo $data->c_listing_number__c ?></a></div>
                    <div class="col-3" style="margin-bottom: 0.5rem;"><label style="font-size: 8px;color: #979191;display: block; margin-bottom: 0;">Listing Price</label><a  style="font-size: 8px;"><?php echo $data->c_listing_price__c ?></a></div>
                    <div class="col-auto" style="margin-bottom: 0.5rem;"><label style="font-size: 8px;color: #979191;display: block; margin-bottom: 0;">Client Status</label><a style="font-size: 8px;"><?php echo $data->c_client_status__c ?></a></div>
                </div>
            </div>
        </div>
    </div>
