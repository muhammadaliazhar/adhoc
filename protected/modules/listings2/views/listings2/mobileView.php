...
Yii::app()->clientScript->registerScriptFile(Yii::app()->controller->module->assetsUrl.'/js/View.js?1');
...
<div <?php //if(isset($background)) echo $background; ?> style='background: #203046;' class="preview-header">
    <div class="columns" style="width: 100%;">
        <div class="d-flex flex-column py-2">
            <div class="text-light p-2" style="font-size: 1.5rem;"><i class="fas fa-building text-light " style="padding-right: 1rem; font-size: 1.5rem;"></i><?php echo $model->name; ?></div>
            <div class="text-light pt-1 pb-2 px-2"><i class="fas fa-barcode text-light" style="padding-right: 1rem; font-size: 1rem;"></i><a><?php echo $model->c_listing_number__c; ?></a></div>
            <div class="text-light p-2"><i class="fas fa-money text-light" style="padding-right: 1rem; font-size: 1rem;"></i><a><?php echo "$" . $model->c_listing_price__c;  ?></a></div>
        </div>
...
<div class="property-menu" style="padding-top: 10px; height:calc(100% + 1000px); border-radius: 30px 30px 0px 0px;">
    ...
    <div id="Details" style="margin-bottom: 400px;" class="tabcontent">
        <div class="column grid-view" id="properties-grid">
            <table>
                <tbody>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner" style="padding: 10px 0px 10px 10px; color: black;">Name: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->name;?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">AssignedTo: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('assignedTo', TRUE, TRUE);?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Listing Number: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_listing_number__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Listing Price: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_listing_price__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Down Payment: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_down_payment_requested__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Address: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_address');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Alt. Address: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_Address_2');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">City: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_city__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">State: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_state__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">County: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_country__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Description:</div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_business_description__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Client Status: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_client_status__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">TOM Status: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_tom_marketing_status__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Total Sales: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_total_sales__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Ad Headline: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_ad_headline__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Seller Disc. Earnings: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_seller_discretionary_earnings__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Client Agree. Date: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_client_agreement_date__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Client Agree. Expires: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_client_agreement_expires__c');?></span></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td class="d-flex"><div class="col-6 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Seller: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_Seller');?></span></div> </td></tr>
                </tbody>
            </table>
        </div>
        <script>
        function goToUpdate(){
            document.location.href='<?php echo Yii::app()->createUrl('/listings2/update',array('id'=>$model->id));?>';
...
<div id="mobileFooter" class="w-100" style='padding-left: 0px; padding-right: 0px; position: fixed; bottom: 0; z-index: 500;'>
    <div class="w-100" style="margin-right: auto; margin-left: auto; padding-left: 6%; padding-right: 9%; background-color: white;">
        <button style="" id="updateRecord" type="button" class="btn btn-primary w-100 mb-2 mx-1" onclick='goToUpdate()'>Edit</button>
        <button id="send-button" class="btn btn-warning w-100 mb-2 mx-1" style="display: none;" onclick="SendDocMobile()">Send</button>
    </div>
