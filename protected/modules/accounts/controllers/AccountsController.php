...
class AccountsController extends x2base {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('index', 'view', 'create', 'update', 'search', 'addUser', 'removeUser', 'convet',
    ...
    public function actionView($id) {
        ...
        if ($model->checkForDuplicates() && Yii::app()->params->isAdmin) {
...
<br />".Yii::t('app', 'Link') . ": " . CHtml::link($model->name,
    ...
    public function insertMenu($selectOptions = array(), $model = null, $menuParams = null) {
        ...
        $menuItems = array(
            ...
            array(
                'name'=>'convert',
                'label' => Yii::t('Accounts', 'Convert {account}', array(
                    '{account}' => $Account,
                )),
                'url' => '#',
                'linkOptions' => array ('id' => 'convert-account-button'),
            ),
	        ),
