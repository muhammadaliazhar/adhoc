...
<?php
$columns[1]['value'] = 'CHtml::link($data->renderName(),"/index.php/docs/library/".$data->libraryId)';
$this->widget('X2GridView', array(
	...
	'template'=> 
        ...
        '<div id="x2-gridview-page-title" '.
         'class="page-title x2-gridview-fixed-title libraries">'.
	...
	'specialColumns'=>array(
		'name'=>array(
			'name'=>'name',
			'value'=>'$data->name == "Corporate" ? CHtml::link($data->name, "https://transworldbusiness.sharepoint.com/sites/TransworldBusinessAdvisors/Shared%20Documents/Forms/AllItems.aspx") : CHtml::link($data->name,"/index.php/docs/library/".$data->id)',
			'type'=>'raw',
		),
		'description'=>array(
			'name'=>'description',
