...
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/NDAADDfunction.js');

//include("protected/modules/ndaconfigure/ndaconfigureConfig.php");
...
$modelType = json_encode("Ndaconfigure");
...
<div class="page-title-fixed-outer">
    <div class="page-title-fixed-inner">
        <div class="page-title ndaconfigure">
            <h2>
            ...
            //echo X2HTML::editDocsButton($model->id, $model->c_default_nda);
            //echo X2HTML::addDocsPacketButton($model->id);
            ?>
        </div>
    </div>
</div>
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'ndaconfigure')); ?>
            <br>
            <div><?php echo X2Html::editDocsBotButton($model->id, $model->c_default_nda); ?></div>
            <div><span>Click the 'Edit NDA Document(s)' button above to add your default office NDA</span></div>
