...
class NdaconfigureController extends x2base {

    public $modelClass = 'Ndaconfigure';
    ...
    public function actionCreate() {
        $model=new Ndaconfigure;
        $users=User::getNames();

        if(isset($_POST['Ndaconfigure'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Ndaconfigure']);
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='ndaconfigure-form') {
