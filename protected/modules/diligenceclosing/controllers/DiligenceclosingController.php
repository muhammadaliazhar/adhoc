...
class DiligenceclosingController extends x2base {

    public $modelClass = 'Diligenceclosing';
    ...
    public function actionCreate() {
        $model=new Diligenceclosing;
        $users=User::getNames();

        if(isset($_POST['Diligenceclosing'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Diligenceclosing']);
    ...
    public function actionIndex() {
        $model=new Diligenceclosing('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='diligenceclosing-form') {
