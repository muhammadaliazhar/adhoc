...
Yii::app()->clientScript->registerScript('setFieldsReadOnly', "
    ...
    $('#Offices_c_zipcode').prop('readonly', true);
...
", CClientScript::POS_END);
?>
<div class="page-title offices"><h2><?php echo Yii::t('module','Create New {X}',array('{X}'=>Modules::itemDisplayName())); ?></h2></div>

<?php 
$this->widget ('FormView', array(
	'model' => $model
));
//echo $this->renderPartial('application.components.views.@FORMVIEW', array('model'=>$model,'users'=>$users,'modelName'=>'offices')); ?>
