...
echo '<input type="hidden" id="Employees[c_email__c]" name="Employees[c_email__c]">';
...
$this->widget('X2GridView', array(
	...
	'template'=> 
        ...
        '<div id="x2-gridview-page-title" '.
         'class="page-title x2-gridview-fixed-title franchisees">'.
	...
	'filter'=>$model,
	// 'columns'=>$columns,
	'modelName'=>'Franchisees',
	'viewName'=>'franchisees',
