...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        ?>
        <br />
        <label><?php echo Yii::t('groups','{children}', array(
            '{children}' => "Child Groups",
        ));?></label>
        <?php
            echo CHtml::dropDownList('children[]', isset($childrenSelected)?$childrenSelected:"", Groups::getNames(), array('class'=>'multiselect', 'multiple'=>'multiple'));
        ?>
        <br />
