...
class X2LeadsController extends x2base {
    ...
    public function accessRules() {
        return array(
            array('allow',
                'actions'=>array('getItems', 'OpenPage'),
                'users'=>array('*'),
            ),
    ...
    public function actionOpenPage(){
        $this->redirect('https://www.seproposals.com/x2login.aspx?crm_user_id=' . Yii::app()->user->id  . '&crm_user_email=' . Yii::app()->params->profile->emailAddress);
    }
    ...
    public function actionView($id, $opportunity=null) {
        ...
        if($this->checkPermissions($model,'view') || is_null($model->assignedTo)){
	...
	//file_put_contents("/tmp/Justin5.txt", "actionCreate2: ". CJSON::encode($model->assignedTo), FILE_APPEND);
    ...
    public function actionMobileCreatePost($atts){
        ...
        $model->save();
        $this->redirect(array('x2Leads/view','id'=>$model->id));
    ...
    public function insertMenu($selectOptions = array(), $model = null, $menuParams = null) {
        ...
        $menuItems = array(
            ...
            array(
                ...
                'url'=>array('site/exportModels', 'model'=>'X2Leads')
                //'visible'=>Yii::app()->params->isAdmin
            ),
                      array(
                'name' => 'createList',
