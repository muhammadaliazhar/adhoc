...
<div class="property-menu" style="padding-top: 10px; height:100%; border-radius: 30px 30px 0px 0px;">
    ...
    <div id="Details" class="tabcontent" style="margin-bottom: 150px;">
        <div class="column grid-view" id="properties-grid">
            ...
            <table>
                <tbody>
                    ...
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Lead Source: <?php echo $model->renderInput('leadsource',array("style"=>"width:100%"));?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Contact Type: <?php echo $model->renderInput('c_contact_type__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Contact Category: <?php echo $model->renderInput('c_type__c');?></div> </td></tr>
        ...
        function updateRecord(){
            var optionsToPass = [['X2Leads_name','name'],['X2Leads_c_email','c_email'],['X2Leads_c_phone','c_phone'],['X2Leads_c_mobilephone','c_mobilephone'],['X2Leads_c_contact_type__c','c_contact_type__c'],['X2Leads_c_type__c','c_type__c'],['X2Leads_description','description'],['X2Leads_c_ttl_address__c','c_ttl_address__c'],['X2Leads_c_ttl_address__c','c_ttl_address__c'],['X2Leads_c_ttl_city__c','c_ttl_city__c'],['X2Leads_c_ttl_state_province__c','c_ttl_state_province__c'],['X2Leads_c_ttl_country__c','c_ttl_country__c']];
            ...
            document.location.href='<?php echo Yii::app()->createUrl('/x2Leads/mobileUpdate');?>'+ '?atts='+encodeURIComponent(JSON.stringify(passVars));
