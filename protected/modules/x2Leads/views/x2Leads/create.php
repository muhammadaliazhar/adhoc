    ...
    place.address_components.forEach(function(addrComp){
        switch(addrComp.types[0]) {
            ...
            case 'administrative_area_level_2':
                 $('#X2Leads_c_ttl_county__c').val(addrComp.long_name);
                 if($('#location-withdrawn-checkbox').is(':checked')){
                     $('#X2Leads_c_ttl_county__c').val('Withdrawn');
                 }
                 break;
            case 'country':
...
Yii::app()->clientScript->registerScript('autoFillFields', "
    $('#X2Leads_c_createdbyid').val('$me->username');
    $('#X2Leads_c_createdbyid').attr('disabled', true);
", CClientScript::POS_END);
