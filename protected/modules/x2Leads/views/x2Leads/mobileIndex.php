    ...
    <div class="pt-3 container rounded" style="background-color: #f4f4f4;">
        ...
        <div class="w-100 mb-2">
            <div class="w-100 mb-3">
                <a style="color:white;"href="<?php echo Yii::app()->request->baseUrl.'/index.php/x2Leads/create' ?>"><button class="w-100 btn btn-large py-2" style="background-color: #2b3f58;border-color: #2b3f58; color: white;border-radius: 0.75rem;font-size: small;"><i class="fa fa-plus mr-2"></i>CREATE CONTACT RECORD</button></a>
            </div>
        </div>
    <?php
        $this->widget('X2ListView', array(
            'id'=>'properties-grid',
            'ajaxUpdate' => true,
            'ajaxUrl' => Yii::app()->request->baseUrl.'/index.php/contacts/searchSellers',
