...
$ConFields = X2Model::model("Login_notices")->getFields();
foreach ($ConFields as $field) {
    echo '<input type="hidden" id="Login_notices[' . $field->fieldName . ']" name="Login_notices[' . $field->fieldName . ']">';
}
?>
...
$this->widget('X2GridView', array(
	...
	'template'=> 
        ...
        '<div id="x2-gridview-page-title" '.
         'class="page-title x2-gridview-fixed-title login_notices">'.
	...
	'filter'=>$model,
	// 'columns'=>$columns,
	'modelName'=>'Login_notices',
	'viewName'=>'login_notices',
