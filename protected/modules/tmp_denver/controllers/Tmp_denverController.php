...
class Tmp_denverController extends x2base {

    public $modelClass = 'Tmp_denver';
    ...
    public function actionCreate() {
        $model=new Tmp_denver;
        $users=User::getNames();

        if(isset($_POST['Tmp_denver'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Tmp_denver']);
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='tmp_denver-form') {
