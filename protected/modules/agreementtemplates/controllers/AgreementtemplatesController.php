...
class AgreementtemplatesController extends x2base {

    public $modelClass = 'Agreementtemplates';
    ...
    public function actionCreate() {
        ...
        if(isset($_POST['Agreementtemplates'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Agreementtemplates']);
    ...
    public function actionIndex() {
        $model=new Agreementtemplates('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='agreementtemplates-form') {
