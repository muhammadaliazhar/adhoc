...
$modelType = json_encode("Agreementtemplates");
...
<div class="page-title-fixed-outer">
    <div class="page-title-fixed-inner">
        <div class="page-title agreementtemplates">
            <h2>
...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'agreementtemplates')); ?>
...
$this->widget ('ModelFileUploader', array(
    'associationType' => 'agreementtemplates',
