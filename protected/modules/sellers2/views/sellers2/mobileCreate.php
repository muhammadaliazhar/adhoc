...
<div class="property-menu" style="padding-top: 10px; height:100%; border-radius: 30px 30px 0px 0px;">
    ...
    <div id="Details" class="tabcontent" style="margin-bottom: 150px;">
        ...
        function updateRecord(){
            var passVars = {};
            var optionsToPass = [['Sellers2_name','name'],['Sellers2_c_email','email'],['Sellers2_c_phone','c_phone'],['Sellers2_assignedTo_assignedToDropdown','assignedTo'],['Sellers2_c_leadsource','c_leadsource']];
            optionsToPass.forEach(function(element){
                passVars[element[1]] = $("#" + element[0]).val();
            })
            console.log(passVars);
            document.location.href='<?php echo Yii::app()->createUrl('/sellers2/mobileCreatePost');?>'+ '?atts='+encodeURIComponent(JSON.stringify(passVars));
    ...
    <div id="Activity" class="tabcontent">
        ...
        $criteria = $model->getAccessCriteria();
         $criteria = $criteria->addCondition("type != 'emailOpened' AND associationType = 'Sellers2' AND associationId = '" . $model<label for="settings-notification-button">Mute view and download notifications</label>
            </div>
        </div>
