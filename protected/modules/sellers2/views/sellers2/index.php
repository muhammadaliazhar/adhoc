...
if (Yii::app()->params->isAdmin) {
    $this->actionMenu = $this->formatMenu(array(
        ...
        array('label' => Yii::t('module', 'More {X} Lists', array('{X}' => Modules::itemDisplayName())), 'url' => array('lists')),
...
echo '<input type="hidden" id="Sellers2[c_email]" name="Sellers2[c_email]">';
...
$this->widget('X2GridView', array(
	...
	'template'=> 
        ...
        '<div id="x2-gridview-page-title" '.
         'class="page-title x2-gridview-fixed-title sellers2">'.
