            ...
            <div class="col-auto px-3" style="min-height: 100px;">
                <div class="row pb-3">
                    ...
                    <div id="seller-view-btn" class="d-flex justify-content-end col-4">
                        <button type="button" class="btn btn-view" style=""><a href="<?php echo Yii::app()->getBaseUrl(true) . "/index.php/sellers2/" . $data->id ?>">VIEW</a></button>
                    </div>
                </div>
                <div class="row justify-content-between">
                    <div class="col-3" style="margin-bottom: 0.5rem;"><label style="font-size: 8px;color: #979191;display: block; margin-bottom: 0;">Phone</label><a href="tel:<?php echo $phoneRaw ?>" style="font-size: 8px;"><?php echo $data->c_phone ?></a></div>
                    ...
                    <div class="col-auto" style="margin-bottom: 0.5rem;"><label style="font-size: 8px;color: #979191;display: block; margin-bottom: 0;">Email</label><a href="mailto:<?php echo $data->c_email ?>" style="font-size: 8px;"><?php echo $data->c_email ?></a></div>
                </div>
            </div>
        </div>
    </div>
