                        ...
                        for(var j=0;j < dropdownDataArray.length, i<5;j++) {
                            ...
                            if ($(id).length > 0){
                                ...
                                if ($('#Sellers2_c_category_field-input').length > 0){
                                    if ($('#Sellers2_c_subcategory_1').length > 0)
                                        $('#Sellers2_c_subcategory_1').append(s);
                                    if ($('#Sellers2_c_subcategory_2').length > 0)
                                        $('#Sellers2_c_subcategory_3').append(s);
                                    if ($('#Sellers2_c_subcategory_3').length > 0)
                                        $('#Sellers2_c_subcategory_4').append(s);
                                    if ($('#Sellers2_c_subcategory_4').length > 0)
                                        $('#Sellers2_c_subcategory_4').append(s);
                                } else {
...
Yii::app()->clientScript->registerScript('autoFillFields', "
    $('#Sellers2_c_createdbyid').val('$me->username');
    $('#Sellers2_c_createdbyid').attr('disabled', true);
", CClientScript::POS_END);
...
<div class="page-title sellers2"><h2><?php echo Yii::t('module','Create New {X}',array('{X}'=>Modules::itemDisplayName())); ?></h2></div>
...
//echo $this->renderPartial('application.components.views.@FORMVIEW', array('model'=>$model,'users'=>$users,'modelName'=>'sellers2')); ?>
