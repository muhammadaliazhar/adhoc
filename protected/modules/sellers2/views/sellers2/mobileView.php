...
<div <?php //if(isset($background)) echo $background; ?> style='background: #203046;' class="preview-header">
    <div class="columns" style="width: 100%;">
        <div class="d-flex flex-column py-2">
            ...
            <div class="text-light pt-1 pb-2 px-2"><i class="fas fa-envelope text-light" style="padding-right: 1rem; font-size: 1rem;"></i><a href="mailto:<?php echo $model->c_email; ?>"><?php echo $model->c_email; ?></a></div>
            <div class="text-light p-2"><i class="fas fa-phone text-light" style="padding-right: 1rem; font-size: 1rem;"></i><a href="tel:<?php echo $model->c_phone; ?>"><?php echo $model->c_phone;  ?></a></div>
        </div>
...
<div class="property-menu" style="padding-top: 10px; height:calc(100% + 400px); border-radius: 30px 30px 0px 0px;">
    ...
    <div id="Details" style="margin-bottom: 200px;" class="tabcontent">
        <!-- <button style=" margin-left: 25px;" id="updateRecord" type="button" class="btn btn-primary" onclick='goToUpdate()'>Edit</button> -->
        <div class="column grid-view" id="properties-grid">
            <table>
                <tbody>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner" style="padding: 10px 0px 10px 10px; color: black;">Name: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->name;?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner" style="padding: 10px 0px 10px 10px; color: black;">Email: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->c_email;?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Phone: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_phone');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">AssignedTo:</div> <div class="pl-2 d-flex align-items-center"> <span class="field-data"><?php echo $model->renderAttribute('assignedTo', TRUE, TRUE);?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Mobile Phone: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_mobilephone');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Lead Source: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_leadsource');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Status: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_status__c');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Stage: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_stage__c');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Description: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('description');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Address: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_ttl_address__c');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">City: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_ttl_city__c');?></span></div></td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">State: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_ttl_state_province__c');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">County: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_ttl_country__c');?><span></div></td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Listing Lookup:</div> <div class="pl-2 d-flex align-items-center"> <span class="field-data"><?php echo $model->renderAttribute('c_listinglookup__c');?></span></div> </td></tr>
                    <tr style="background: #f3f6f9;"><td class="d-flex"><div class="col-5 property-inner detail-input" style="padding: 10px 0px 10px 10px; color: black !important;">Referred by: </div> <div class="pl-2 d-flex align-items-center"><span class="field-data"><?php echo $model->renderAttribute('c_referredBy');?></span></div> </td></tr>
                </tbody>
            </table>
        </div>
        <!-- <button style=" margin-left: 25px;margin-bottom: 150px;" id="updateRecord" type="button" class="btn btn-primary" onclick='goToUpdate()'>Edit</button> -->
        <script>
        function goToUpdate(){
            document.location.href='<?php echo Yii::app()->createUrl('/sellers2/update',array('id'=>$model->id));?>';
    ...
    <div id="Activity" class="tabcontent" style="margin-bottom: 200px;">
        <style>
          .row {
                margin-right: 0px;
                margin-left: 0px;
