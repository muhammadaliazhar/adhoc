...
<div class="container" style='padding-left: 0px; padding-right: 0px; position: fixed; bottom: 0; z-index: 500;'>
    <div class="w-100" style="margin-right: auto; margin-left: auto; padding-left: 6%; padding-right: 9%; background-color: white;">
        <button onclick="updateRecord()" style="" id="updateRecord" type="button" class="btn btn-primary w-100 mb-2 mx-1">Save</button>
    </div>
...
<div <?php //if(isset($background)) echo $background; ?> style='background: #203046;' class="preview-header">
    <div class="columns" style="width: 100%;">
        <div class="column">
            ...
            <div class="property-zip"><i class="fas fa-envelope text-light" style="padding-right: 0.5rem; font-size: 1rem;"></i><?php echo $model->c_email; ?></div>
            <div class="property-inner"><i class="fas fa-phone text-light" style="padding-right: 0.5rem; font-size: 1rem;"></i><?php echo $model->c_phone;  ?></div>
...
<div class="property-menu" style="padding-top: 10px; height:100%; border-radius: 30px 30px 0px 0px;">
    ...
    <div id="Details" class="tabcontent" style="margin-bottom: 150px;">
        <div class="column grid-view" id="properties-grid">
            <table>
                <tbody>
                    ...
                    <tr style="background: #f0f3f8;"><td style=""><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Email: <?php echo $model->renderInput('c_email');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Phone: <?php echo $model->renderInput('c_phone');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">AssignedTo: <?php echo $model->renderInput('assignedTo',array("style"=>"width:100%"));?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Mobile Phone: <?php echo $model->renderInput('c_mobilephone');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Lead Source: <?php echo $model->renderInput('c_leadsource',array("style"=>"width:100%"));?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Status: <?php echo $model->renderInput('c_status__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Stage: <?php echo $model->renderInput('c_stage__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Description: <?php echo $model->renderInput('description');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Address: <?php echo $model->renderInput('c_ttl_address__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">City: <?php echo $model->renderInput('c_ttl_city__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">State: <?php echo $model->renderInput('c_ttl_state_province__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">County: <?php echo $model->renderInput('c_ttl_country__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Listing Lookup: <?php echo $model->renderInput('c_listinglookup__c');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Referred by: <?php echo $model->renderInput('c_referredBy',array("style"=>"width:100%"));?></div> </td></tr>
                </tbody>
            </table>
        </div>
        ...
        function updateRecord(){
            var optionsToPass = [['Sellers2_name','name'],['Sellers2_c_email','email'],['Sellers2_c_phone','c_phone'],['Sellers2_assignedTo_assignedToDropdown','assignedTo'],['Sellers2_c_mobilephone','c_mobilephone'],['Sellers2_c_leadsource','c_leadsource'],['Sellers2_c_status__c','c_status__c'],['Sellers2_c_stage__c','c_stage__c'],['Sellers2_description','description'],['Sellers2_c_ttl_address__c','c_ttl_address__c'],['Sellers2_c_ttl_city__c','c_ttl_city__c'],['Sellers2_c_ttl_state_province__c','c_ttl_state_province__c'],['Sellers2_c_ttl_country__c','c_ttl_country__c'],['Sellers2_c_listinglookup__c_id0','c_listinglookup__c'],['Sellers2_c_referredBy_id1','c_referredBy']];
            ...
            document.location.href='<?php echo Yii::app()->createUrl('/sellers2/mobileUpdate');?>'+ '?atts='+encodeURIComponent(JSON.stringify(passVars));
