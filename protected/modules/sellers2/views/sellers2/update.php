...
Yii::app()->clientScript->registerScript('placeMap', "
  var map = $('#googlemap');
  $('.formSection:nth-child(2)').append($('#googlemap'));
  $('#Sellers2_c_ttl_address__c_field').append($('#location-withdrawn_field'));
", CClientScript::POS_END);
?>

<div class="page-title sellers2"><h2><?php echo Yii::t('module','Update Existing {X}',array('{X}'=>Modules::itemDisplayName())); ?></h2></div>
