...
class GeographiesController extends x2base {

    public $modelClass = 'Geographies';
    ...
    public function actionCreate() {
        $model=new Geographies;
        $users=User::getNames();

        if(isset($_POST['Geographies'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Geographies']);
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='geographies-form') {
