...
class Workflow extends X2ActiveRecord {
    ...
    public function beforeDelete() {
        ...
        if (is_null($this->id) || empty($this->id))
            throw new CHttpException(515, Yii::t('app', 'Please email megan@tworld.com and tell her what you are doing because it is passing some bad data.'));
    ...
    public function search() {
        ...
        //a check to hide the flow from non admins
        if(!Yii::app()->params->isAdmin) $criteria->addCondition('id != 10', 'AND');
