...
class DataroomController extends x2base {

    public $modelClass = 'Dataroom';
    ...
    public function actionCreate() {
        ...
        if(isset($_POST['Dataroom'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Dataroom']);
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='dataroom-form') {
