...
class Docusign_templatesController extends x2base {

    public $modelClass = 'Docusign_templates';
    ...
    public function actionCreate() {
        $model=new Docusign_templates;
        $users=User::getNames();

        if(isset($_POST['Docusign_templates'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Docusign_templates']);
    ...
    public function actionIndex() {
        $model=new Docusign_templates('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='docusign_templates-form') {
