...
<div <?php //if(isset($background)) echo $background; ?> style='background: #203046;' class="preview-header">
    <div class="columns" style="width: 100%;">
        <div class="column">
            ...
            <div class="property-zip"><i class="fas fa-envelope text-light" style="padding-right: 0.5rem; font-size: 1rem;"></i><?php echo $model->email; ?></div>
            <div class="property-inner"><i class="fas fa-phone text-light" style="padding-right: 0.5rem; font-size: 1rem;"></i><?php echo $model->phone;  ?></div>
...
<div class="property-menu" style="padding-top: 10px; height:100%; border-radius: 30px 30px 0px 0px;">
    ...
    <div id="Details" class="tabcontent" style="margin-bottom: 150px;">
        <div class="column grid-view" id="properties-grid">
            ...
            <table>
                <tbody>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">First Name: <?php echo $model->renderInput("firstName");?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Last Name: <?php echo $model->renderInput("lastName");?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td style=""><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Email: <?php echo $model->renderInput('email');?></div> </td></tr>
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Phone: <?php echo $model->renderInput('phone');?></div> </td></tr>
                    ...
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Description: <?php echo $model->renderInput('c_description');?></div> </td></tr>
                    ...
                    <tr style="background: #f0f3f8;"><td><div class="property-inner" style="padding: 10px 0px 10px 10px; color: black;">Listing Number Lookup: <?php echo $model->renderInput('c_listing_number_lookup');?></div> </td></tr>
        ...
        function updateRecord(){
            var optionsToPass = [['Contacts_firstName','firstName'],['Contacts_lastName','lastName'],['Contacts_email','email'],['Contacts_phone','phone'],['Contacts_assignedTo_assignedToDropdown','assignedTo'],['Contacts_c_mobilephone','c_mobilephone'],['Contacts_leadSource','leadSource'],['Contacts_c_listinglookup__c_id0','c_listinglookup__c'],['Contacts_c_listing_number_lookup_id1','c_listing_number_lookup'],['Contacts_c_referredBy','c_referredBy']];
            var passVars = {};
            optionsToPass.forEach(function(element){
                passVars[element[1]] = $("#" + element[0]).val();
            })
            console.log(passVars);
            document.location.href='<?php echo Yii::app()->createUrl('/contacts/mobileCreatePost');?>'+ '?atts='+encodeURIComponent(JSON.stringify(passVars));
