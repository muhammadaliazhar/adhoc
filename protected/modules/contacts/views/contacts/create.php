...
Yii::app()->clientScript->registerScript('autoFillFields', "
    $('#Contacts_c_createdbyid').val('$me->username');
    $('#Contacts_c_createdbyid').attr('disabled', true);
", CClientScript::POS_END);

Yii::app()->clientScript->registerScript('hideFields', "
    $('.quick-create-button.create-Contacts').hide();
", CClientScript::POS_END);
