...
//only show edit or delete if your own list
if(!Yii::app()->params->isAdmin && $listModel->assignedTo != Yii::app()->params->profile->username){
        $menuOptions = array(
                'all', 'lists', 'create', 'createList', 'viewList',
        );
