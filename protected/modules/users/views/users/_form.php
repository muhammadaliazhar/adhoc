...
?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'firstName',array('size'=>20,'maxlength'=>40)); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'storeId',array('size'=>20,'maxlength'=>100,'disabled'=>isset($flag)&&$flag?'disabled':'')); ?>
