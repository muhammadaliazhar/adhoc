...
$menuOptions = array(
    'feed', 'admin', 'create', 'invite', 'view', 'profile', 'edit', 'login','delete',
);
...
foreach($actionHistory as $action) {
    ...
    if ($association)
        $associatedDescription = (isset($association->backgroundInfo) ?
                        $association->backgroundInfo : (isset($association->description) ? $association->description : ""));
	...
	$this->widget('zii.widgets.CDetailView', array(
		...
		'attributes'=>array(
            ...
            array(
				...
				'label'=>'Location',
				'type'=>'raw',
                'value'=>((isset($action->location) && $association instanceof Contacts && isset($action->location->type)) ?
