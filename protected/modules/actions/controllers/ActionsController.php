    ...
    public function actionCreate(){
        ...
        if (isset ($post)){
            if ($model instanceof ActionFormModelBase) {
                ...
                if ($_POST[$type]['associationType'] === "listings2") {
                    $listingNumber = "";
                    $actionAssociated = X2Model::model('Listings2')->findByPk($_POST[$type]['associationId']);
                    $listingNumber = $actionAssociated->c_listing_number__c;
                    $model->actionDescription = "Listing Number: ".$listingNumber." | ".$model->actionDescription;
                }
