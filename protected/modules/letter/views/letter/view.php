...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'letter')); ?>
