...
//        ),
    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            //'caseSensitive'=>false,
            'rules' => array(
                'contacts/x2sign/signDocs' => array('x2sign/x2sign/signDocs', 'parsingOnly'=>true),
                'sellers2/x2sign/signDocs' => array('x2sign/x2sign/signDocs', 'parsingOnly'=>true),
                ...
                //buyer prefs
                'api2/setbuyerpref' => 'api2/setBuyerPref',
                'api2/getBuyerPref' => 'api2/getBuyerPref',
		...
		'api2/<_class:[A-Z]\w+>/searchListings/by:<_findBy:.+>.json'=>'api2/searchListings',
                'api2/<_class:[A-Z]\w+>/searchEmployees/by:<_findBy:.+>.json'=>'api2/searchEmployees',
                'api2/<_class:[A-Z]\w+>/searchFranchisees/by:<_findBy:.+>.json'=>'api2/searchFranchisees',
                'api2/<_class:[A-Z]\w+>/searchOffices/by:<_findBy:.+>.json'=>'api2/searchOffices',
                'api2/<_class:[A-Z]\w+>/searchStates/by:<_findBy:.+>.json'=>'api2/searchStates',
                'api2/<_class:[A-Z]\w+>/searchCountries/by:<_findBy:.+>.json'=>'api2/searchCountries',
		'api2/<_class:[A-Z]\w+>/searchCounties/by:<_findBy:.+>.json'=>'api2/searchCounties',
                'api2/<_class:[A-Z]\w+>/searchCategories/by:<_findBy:.+>.json'=>'api2/searchCategories',
                'api2/<_class:[A-Z]\w+>/searchSubcategories/by:<_findBy:.+>.json'=>'api2/searchSubcategories',
                // ...By ID
