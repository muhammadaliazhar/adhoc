...
<div class="spanMax cell admin-screen">
    ...
    <!--<div class="form x2-layout-island license-info-section">
        ...
        <?php
        if (Yii::app()->contEd('ent') && Yii::app()->params->isAdmin) {
            ?>
            <div class="row">
    ...
    <div class=" x2-layout-island" id="main-admin-panel" style="display:none;">
        <div id="tabs" class="form" style="">
            ...
            <div id="tabs-5" class="admin-tab-content">
                ...
                <?php /* x2entstart */ ?>
                <!--<div class="cell span-6"><?php
                    //echo CHtml::link(Yii::t('admin', 'Landing Page Designer'), array('/marketing/marketing/landingPages'));
                    ?><br><?php
            ...
            <div id="tabs-8" class="admin-tab-content">
                ...
                <!--<div class="cell span-6"><?php
                    ...
                    ?></div>-->
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'Export Records'), array('/site/exportModels'));
                    ?><br><?php
            ...
            <!--<div id="tabs-9" class="admin-tab-content">
                ...
                <?php /* x2entstart */ ?>
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'Code Editor'), array('/admin/codeEditor'));
                    ?><br><?php
