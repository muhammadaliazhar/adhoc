...
$('#agree-eula-btn').click (function (e) {
    $.ajax({
        url: '" . substr(Yii::app()->createAbsoluteUrl(''), 0, -9) . "index.php/site/approveEULA',
        type: 'POST',
        data: {
...
Yii::app()->clientScript->registerCssFile('https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css');
Yii::app()->clientScript->registerScriptFile('https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js', CClientScript::POS_END);
...
//                            Yii::app()->theme->baseUrl.'/images/loginButtonIcon.png', 'X2');
                ...
                <div class='row remember-me-row'>
                    ...
                    <div class="cell need-help-cell">
                        <?php
                        echo CHtml::link(Yii::t('app','Forgot password?'),array('/site/anonHelp'),
...
<div id="eula" class="modal modal-fade" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body" style="overflow: auto;">
                    <?php echo file_get_contents('/var/www/transworld_crm/eula.html'); ?>
                </div>
                <div class="modal-footer">
                    <button id="decline-eula-btn" type="button" class="btn btn-danger">Decline</button>
                    <button id="agree-eula-btn" type="button" class="btn btn-success">I Agree</button>
                </div>
            </div>
        </div>
    </div>
