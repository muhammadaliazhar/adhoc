 ...
 */
?><div class="page-title rounded-top"><h2><?php echo Yii::t('admin', "Delete a custom mapping")  ?></h2></div>
        ...
        <div class="form" id="createUpdateField-container">
            <div style="width:600px">
                ...
                <div class="row">
                    ...
                    echo $form->genericDropDownList('removeModelFrom', $removeModelFrom, $removeModelFromModels, array(
                    ...
                    echo $form->genericDropDownList('removeModelTo', $removeModelTo, $removeModelToModels, array(
                ...
                <div class="row buttons">
                    <?php
                    echo CHtml::submitButton(Yii::t('app', 'Remove'), array(
                        'class' => 'x2-button ' . ($new ? 'new' : 'existing'),
                        'id' => 'createUpdateField-removebutton'
                    ));
                    ?>
                </div>
