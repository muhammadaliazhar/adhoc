...
<div id="condition-templates" style="display:none; margin-top: 15px;">
    ...
    <fieldset class="API_params">
        <div class="zcell x2fields-attribute">
...
$passVarsToClientScript = '
    ...
    x2.fieldUtils = new x2.FlowFields ({
        operatorList: ' . CJSON::encode(FormLayout::getFieldComparisonOptions()) . ',
...
//Yii::app()->clientScript->registerScriptFile(Yii::app()->getBaseUrl() . '/js/X2Flow/X2FlowEditor.js');
Yii::app()->clientScript->registerScriptFile(Yii::app()->getBaseUrl().'/js/x2formEditor.js' ,CClientScript::POS_END);
Yii::app()->clientScript->registerScriptFile(Yii::app()->getBaseUrl().'/js/lib/colResizable/colResizable.js', CClientScript::POS_END);
//Yii::app()->clientScript->registerScriptFile(Yii::app()->getBaseUrl().'/js/X2Fields.js');
...
<div class="form">
    <div class="row">
        ...
        <?php if(count($versionList) > 1 && !empty($id)){ ?>
            ...
            <div class="cell right" style="padding-top:11px;">
                ...
                <?php echo CHtml::button(Yii::t('admin', 'Save'), array('class' => 'x2-button highlight right', 'style' => 'margin-right:5px;', 'id' => 'saveTriggerButton')); ?>
                <?php   //since i need to format conditons I will make a field to hold the formated fields
                    echo CHtml::hiddenField('HoldCondition', '', array('id' => 'HoldCondition')); ?>
    ...
    <div class="form cell" id="x2layout-config-box">    
        <div class="row">
            <?php   
           echo CHtml::button(
                   Yii::t('studio', 'Add Condition'), array(
               'id' => 'x2Layout-add-condition',
               'class' => 'x2-button',
               'style' => 'display:none;height:30px;padding-top:3px;'
               . 'padding-bottom:3px;padding-left:20px;padding-right:20px;'
           ));
            ?>
            <hr id="x2Layout-conditions-hr" style="margin: 5px 0px 5px 0px;">
            <div id="x2Layout-conditions" class="x2-sortlist"><ol></ol></div>
        </div>
    </div>
...
<?php } ?>
<?php if(!empty($id)){ ?>
<?php echo CHtml::hiddenField('conditions',$layoutModel->conditions ,  array('id' => 'ConditionsDataField')); ?>
