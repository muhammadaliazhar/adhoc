...
//$NEWs =  Sellerquestionnairelist2::model()->findAll();
//$OGs = Sellerquestionairre::model()->findAll();
//foreach($OGs as $OG){
//	$newsell = Sellerquestionnairelist2::model()->findByPk($OG->id);
//	if(isset($newsell)){
//		$newFields = $newsell->getFields(true);
//		$Fields = array();
//	        foreach($newFields as $field) {
//        	        $Fields[] = $field->fieldName;
//            	}
// 		if($newsell->lastActivity < $OG->lastActivity){
//			foreach($Fields[] as $check){
//				if(isset($OG->$check)) $newsell->$check = $OG->$check;
//			}
//		}
//		
//	}
...
?>
    ...
    <?php } ?>
        ...
        <div class="row">
            ...
            echo Yii::t('app', 'Email: {email}',
                    array('{email}' => CHtml::link('contact@x2engine.com',
    ...
    <div class="page-title x2-layout-island">
        ...
        echo CHtml::link(Yii::t('admin', 'About X2Engine'),
        ...
        <div id="tabs" class="form">
            ...
            <div id="tabs-1">
                ...
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'X2CRM | X2Engine Inc'),
                            'http://www.x2crm.com');
                    ?><br><?php
                    echo Yii::t('admin',
            ...
            <div id="tabs-5">
                ...
                <?php /* x2entstart */ ?>
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'Landing Page Designer'),
                            array('/marketing/marketing/landingPages'));
                    ?><br><?php
                    echo Yii::t('admin', 'Design landing pages for your website');
                    ?></div>
                <?php /* x2entend */ ?>
            ...
            <div id="tabs-6">
                ...
                <h2 id="admin-workflow"><?php
                    ...
                    ?></h2>
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'X2Workflow'),
                ...
                <div class="cell span-6"><?php
                    ...
                    ?></div>
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'X2Workflow Settings'),
            ...
            <div id="tabs-9">
                ...
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'X2Packager'),
                ...
                <?php /* x2entstart */ ?>
                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'Code Editor'),
                            array('/admin/codeEditor'));
                    ?><br><?php
                    echo Yii::t('admin', 'Develop and modify system source code');
                    ?></div>

                <div class="cell span-6"><?php
                    echo CHtml::link(Yii::t('admin', 'Record Conversion'), array('/admin/convertRecords'));
                    ?><br><?php
                    echo Yii::t('admin', 'Configure mappings between records');
                    ?></div>
            ...
            <div id="tabs-11">
                ...
                <div class="cell span-6">
                    <?php
                    echo CHtml::link(Yii::t('admin', 'Lock or Unlock X2CRM'),
                            array('/admin/lockApp'));
                    ?><br><?php
                    echo Yii::t('admin',
