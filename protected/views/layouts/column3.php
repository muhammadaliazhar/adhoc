...
?>
	...
	if(!isset(Yii::app()->params->profile)){
		throw new CHttpException(400,"no profile");
	}
	...
	//$defaults = array ('ActionMenu', 'TopContacts');
	if(Yii::app()->user->getId() == 3170 ||  Yii::app()->user->getId() == 4644) $defaults = array ('ActionMenu', 'TopContacts');	
