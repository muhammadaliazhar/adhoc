...
namespace
{
    ...
    class SetaPDF_Core_Document_Catalog_Pages
    {
         ...
         * @throws InvalidArgumentException
         */
        public function getPageNumberByIndirectObject(\SetaPDF_Core_Type_IndirectObjectInterface $indirectObject) {}
...
namespace
{
    ...
    class SetaPDF_Core_Writer_TempFile implements \SetaPDF_Core_Writer_WriterInterface, \SetaPDF_Core_Writer_FileInterface
    {
         ...
         * @var string
         */
        protected static $_filePrefix = '.htSetaPDF';
...
namespace
{
    ...
    class SetaPDF_Core_Document
    {
         ...
         * @var array
         */
        protected $_cache = [/** value is missing */];
...
namespace
{
    ...
    abstract class SetaPDF_Core_Font implements \SetaPDF_Core_Font_FontInterface
    {
         ...
         *
         * @param SetaPDF_Core_Document $document
         * @deprecated See {@link SetaPDF_Core_Document::clearCache()} with the type SetaPDF_Core_Document::CACHE_FONT.
         */
        public static function freeCache(\SetaPDF_Core_Document $document) {}
...
namespace
{
    ...
    class SetaPDF_Core
    {
         ...
         * @var string
         */
        const VERSION = 'dev-rev-1425#Build #122 Rev 1425';
