...
$position = [
    'ul' => [$margin, $format[1] / 2, $format[0] / 2, $format[1] - $margin],
    'ur' => [$format[0] / 2 + $margin, $format[1] / 2, $format[0] - $margin, $format[1] - $margin],
    'll' => [$margin, $margin, $format[0] / 2, $format[1] / 2],
    'lr' => [$format[0] / 2, $margin, $format[0] - $margin, $format[1]  / 2],
];
