 ...
 * @version    $Id: Pdf.php 1781 2022-09-27 10:50:21Z jan.slabon $
 */
                    ...
                    switch ($token3) {
                        ...
                        case 'obj':
                            ...
                            if (strpos($this->_reader->getBuffer(), 'stream') === 0) {
                                $value = SetaPDF_Core_Type_Dictionary::ensureType($value);
                                ...
                                try {
                                    $length = SetaPDF_Core_Type_Dictionary_Helper::getValue($value, 'Length', null, true);
                                    if ($length === null) {
