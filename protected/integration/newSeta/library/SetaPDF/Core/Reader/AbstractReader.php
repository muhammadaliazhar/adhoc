 ...
 * @version    $Id: AbstractReader.php 1781 2022-09-27 10:50:21Z jan.slabon $
 */
...
abstract class SetaPDF_Core_Reader_AbstractReader
{
    ...
    {
        $pos = ($pos !== null ? (int)$pos : $this->_offset);
        if ($pos >= $this->_length &&
     ...
     * @param int $minLength
     */
    abstract public function increaseLength($minLength = 100);
