 ...
 * @version    $Id: SecHandler.php 1789 2022-11-09 11:19:00Z jan.slabon $
 */
...
abstract class SetaPDF_Core_SecHandler
{
    ...
    public static function arcfour($key, $data)
    {
        ...
        if (self::$engine === 'openssl' && function_exists('openssl_encrypt')) {
            static $opensslCipherSupported;
            if ($opensslCipherSupported === null) {
                $opensslCipherSupported = in_array('rc4-40', openssl_get_cipher_methods(), true);
            }

            if ($opensslCipherSupported) {
