 ...
 * @version    $Id: Name.php 1733 2022-06-02 07:39:42Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Type_ScalarValue
{
    ...
    /**
     * Ensures that the passed value is a SetaPDF_Core_Type_Name instance.
     *
     * @param mixed $name
     * @return self
     * @throws SetaPDF_Core_Type_Exception
     */
    public static function ensureType($name)
    {
        return self::_ensureType(self::class, $name, 'Name value expected.');
    }
