 ...
 * @version    $Id: Aes256.php 1782 2022-09-28 12:55:13Z jan.slabon $
 */
...
class SetaPDF_Core_SecHandler_Standard_Aes256 extends SetaPDF_Core_SecHandler_Standard
{
    ...
    )
    {
        ...
        $encryptionDict->offsetSet('UE', $ue = new SetaPDF_Core_Type_String());
        $encryptionDict->offsetSet('OE', $oe = new SetaPDF_Core_Type_String());
        $encryptionDict->offsetSet('Perms', $perms = new SetaPDF_Core_Type_String());
        ...
        $permsValue = substr(pack('V', $permissions), 0, 4)
               . "\xFF\xFF\xFF\xFF"
        ...
        // encryption key as the key.
        if (SetaPDF_Core_SecHandler::$engine === 'mcrypt') {
            $ivSize     = mcrypt_get_iv_size(MCRYPT_RIJNDAEL_128, MCRYPT_MODE_ECB);
            $permsValue = mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $instance->_encryptionKey, $permsValue, MCRYPT_MODE_ECB, str_repeat("\0", $ivSize));
