 ...
 * @version    $Id: Standard.php 1782 2022-09-28 12:55:13Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_SecHandler_SecHandlerInterface
{
    ...
    {
        return (int)SetaPDF_Core_Type_Numeric::ensureType(
            SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'R'
        ))->getValue();
    }
     ...
     * @return string|boolean The encryption key if the authentication was successful.
     *                        <b>False</b> if not.
     * @throws SetaPDF_Core_SecHandler_Exception
     * @throws SetaPDF_Core_Type_Exception
     * @throws SetaPDF_Exception_NotImplemented
    ...
    protected function _authByUserPassword($userPassword = '')
    {
        ...
        if ($revision < 5) {
            ...
            $originalUValue = SetaPDF_Core_Type_AbstractType::ensureWithType(
                SetaPDF_Core_Type_StringValue::class,
                SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'U')
            )->getValue();
            ...
            $uValue = SetaPDF_Core_Type_AbstractType::ensureWithType(
                SetaPDF_Core_Type_StringValue::class,
                SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'U')
            )->getValue();
            ...
            if (strpos($uValue, $hash) === 0) {
                ...
                $ueValue = SetaPDF_Core_Type_AbstractType::ensureWithType(
                    SetaPDF_Core_Type_StringValue::class,
                    SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'UE')
                )->getValue();
                ...
                $perms = SetaPDF_Core_Type_AbstractType::ensureWithType(
                    SetaPDF_Core_Type_StringValue::class,
                    SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'Perms')
                )->getValue();
     ...
     * @return string|boolean The encryption key if the authentication was successful. <b>False</b> if not.
     * @throws SetaPDF_Exception_NotImplemented
     * @throws SetaPDF_Core_Type_Exception
     * @throws SetaPDF_Core_SecHandler_Exception
     */
    protected function _authByOwnerPassword($ownerPassword = '')
    {
        ...
        if ($revision < 5) {
            ...
            $originalOValue = SetaPDF_Core_Type_AbstractType::ensureWithType(
                SetaPDF_Core_Type_StringValue::class,
                SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'O')
            )->getValue();
            ...
            // (exclusive or)
                ...
                throw new SetaPDF_Core_SecHandler_Exception('Unsupported revision 1.');
            }
        ...
        if ($revision === 5 || $revision === 6) {
            ...
            // The first 32 bytes are a hash value (explained below). The next 8 bytes are
            // called the Validation Salt. The final 8 bytes are called the Key Salt.
            $oValue = SetaPDF_Core_Type_AbstractType::ensureWithType(
                SetaPDF_Core_Type_StringValue::class,
                SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'O')
            )->getValue();
            $uValue = SetaPDF_Core_Type_AbstractType::ensureWithType(
            ...
            if (strpos($oValue, $hash) === 0) {
                ...
                $oeValue = SetaPDF_Core_Type_AbstractType::ensureWithType(
                    SetaPDF_Core_Type_StringValue::class,
                    SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'OE')
                )->getValue();
    ...
    public function getPermissions()
    {
        ...
        $currentPerm = SetaPDF_Core_Type_Numeric::ensure32BitInteger(
            SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'P', 0, true)
        );
    ...
    protected function _computeEncryptionKey($password = '')
    {
        ...
        if ($revision <= 4) {
            ...
            $s .= SetaPDF_Core_Type_AbstractType::ensureWithType(
                SetaPDF_Core_Type_StringValue::class,
                SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'O')
            )->getValue();
            ...
            $pValue = SetaPDF_Core_Type_Numeric::ensure32BitInteger(
                SetaPDF_Core_Type_Dictionary_Helper::getValue($this->_encryptionDictionary, 'P', 0, true)
            );
            $s .= pack('V', $pValue);
