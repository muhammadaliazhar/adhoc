 ...
 * @version    $Id: PushButton.php 1706 2022-03-28 10:40:28Z jan.slabon $
 */
    ...
    implements SetaPDF_FormFiller_Field_FieldInterface
{
    ...
    /**
     * Implementation of {@link SetaPDF_FormFiller_Field_FieldInterface::setDefaultValue()} - not usable!
     *
     * @param mixed $value
     * @param string $encoding
    ...
    /**
     * Implementation of {@link SetaPDF_FormFiller_Field_FieldInterface::setValue()} - not usable!
     *
     * @param mixed $value
     * @throws BadMethodCallException
     * @internal
    ...
    /**
     * Implementation of {@link SetaPDF_FormFiller_Field_FieldInterface::recreateAppearance()} - without functionality!
     * @internal
     */
