 ...
 * @version    $Id: Som.php 1665 2021-11-30 16:24:58Z maximilian.kresse $
 */
...
class SetaPDF_FormFiller_Xfa_Som
{
     ...
     * @return DOMElement|DOMElement[]|DOMAttr|bool
     * @throws Exception
     */
            ...
            switch ($name) {
                ...
                default:
                    ...
                    foreach ($context AS $_context) {
                        ...
                        if (
                            $_context->namespaceURI !== null
                            && strpos($_context->namespaceURI, 'http://www.xfa.org/schema/xfa-template') === 0
                        ) {
    ...
    protected function _evaluateDirectMatch($name, DOMElement $context, array &$result)
    {
        ...
        foreach ($childNodes AS $childNode) {
            if (!$childNode instanceof DOMElement ||
                ($childNode->tagName !== 'field' && $childNode->tagName !== 'subform' && $childNode->tagName !== 'area')
            ) {
                continue;
            }

            if ($childNode->tagName === 'area' || !$childNode->hasAttribute('name') ||
